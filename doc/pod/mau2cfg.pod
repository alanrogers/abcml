=head1 MAU2CFG Documentation File
...
living animals.  See F<files> for descriptions of these formats.

  Usage: mau2cfg filename.bdf filename.mau

where F<filename.bdf> is the bone definition file and F<filename.mau>
